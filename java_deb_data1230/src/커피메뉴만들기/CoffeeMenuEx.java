...
public class CoffeeMenuEx {
    ...
    void makeMenu() {
        ...
        map.put("Latte", new MenuInfo("Latte", 4500, "Coffee", "우유가 들어간 커피"));
    }
    void selectMenu() {
        ...
        while (true) {
            ...
            switch (selMenu) {
                ...
                case 2 :
                    ...
                    key = sc.next();
                    if (map.containsKey(key)) { // map내에 키가 존재 하는지 확인 (있으면 true)
                ...
                case 3 :
                    ...
                    if (map.containsKey(key)){
                        System.out.print("해당 메뉴가 이미 존재 합니다.");
                    } else {
