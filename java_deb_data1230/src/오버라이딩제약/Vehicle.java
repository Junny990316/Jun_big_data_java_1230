...
public class Vehicle {
     protected int speed; // protected 는 상속관계와 동일 패키지는 포함 하지만 외부에서는 접근하지 못함
     protected String color;
     protected String name;
    // final은 최종 상태를 의미하며, 메소드에서 사용 시 오버로딩이 불가 함을 의미 합니다.
...
class SportsCar extends Vehicle {
    ...
    SportsCar(String name) {
        isTurbo = false; // 터보모드가 켜지면 차의 최고 속도를 증가시킴
