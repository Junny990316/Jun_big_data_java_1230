...
public interface NetworkAdapter {
    void connect(); // public abstract 자동으로 들어가 있음
}
class WiFi implements NetworkAdapter {
    ...
    @Override
    public void connect() {
        System.out.println(company + "의 WiFi에 연걸 되었습니다.");
    }
}
class FiveG implements  NetworkAdapter {
    ...
    @Override
    public void connect() {
        System.out.println(company + "의 5G에 연걸 되었습니다.");
    }
}
class LTE implements NetworkAdapter {
    ...
    @Override
    public void connect() {
        System.out.println(company + "의 LTE에 연걸 되었습니다.");
    }
}