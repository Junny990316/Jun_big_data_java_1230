package 함수형프로그램예제1번;
// 함수형 프로그램 : 자바8에서 도입, 수학공식과 유사, 불변성의 원칙, 조건문, 반복문 사용 금지 등의 특징을 가짐
//람다(Lambda) : 화살표 표현식으로 사용됨. 생락 가능한 모든 것을 생략하는 것을 기본 원칙으로 함
// 함수형 인터페이스 : 자바는 함수가 독립적으로 존재 할 수 없으므로 함수형 인터페이스가 필요함
@FunctionalInterface
