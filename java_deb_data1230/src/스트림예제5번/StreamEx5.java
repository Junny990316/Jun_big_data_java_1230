...
// 중개 연산 : 생성된 스트림은 중개 여산을 통해 또 다른 스트림으로 변환, 중개 연산은 연속으로 연결해서 사용 가능
// filter() : 조건에 맞는 요소만으로 구성된 새로운 반환
...
//        System.out.println();
        ...
        // 스트림 제한
        // limit() : 해당 스트림에서 첫번째 요소부터 전달된 개수 만큼의 요소로만 이루어진 새로운 스트림 반환
        // skip() : 해당 스트림의 첫번째 요소부터 전달 된 개수 마큼의 요소를 제외하고 출력
