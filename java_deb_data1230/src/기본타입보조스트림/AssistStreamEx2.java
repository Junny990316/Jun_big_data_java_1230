...
// 기본타입보조스트림 : 바이트 스트림은 바이트 단위로 입출력하기 때문에 자바의 기본 데이터 타입을 사용할 수 없다
...
public class AssistStreamEx2 {
    public static void main(String[] args) throws IOException {
        ...
        DataOutputStream dos = new DataOutputStream(fos); // 프로그램에서 사용할 수 있는 기본타입을 지원하는 보조 스트림
        ...
        for (int i =0; i < 3; i++) {
            String name = dis.readUTF(); // 문자열 읽음
